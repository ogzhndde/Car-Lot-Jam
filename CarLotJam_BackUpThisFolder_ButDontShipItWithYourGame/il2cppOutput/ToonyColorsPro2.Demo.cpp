...
IL_008d:
	...
	{
		bool L_18;
		L_18 = Input_GetMouseButton_mE545CF4B790C6E202808B827E3141BEC3330DB70(0, NULL);
		if (L_18)
		{
			goto IL_00a4;
		}
...
IL_00a4:
	{
		...
		bool L_19;
		L_19 = Input_GetMouseButtonDown_m33522C56A54C402FE6DED802DD7E53435C27A5DE(1, NULL);
		if (!L_19)
		{
			goto IL_00b8;
		}
...
IL_00b8:
	{
		...
		bool L_21;
		L_21 = Input_GetMouseButtonUp_m69FCCF4E6D2F0E4E9B310D1ED2AD5A6927A8C081(1, NULL);
		if (L_21)
		{
			goto IL_00c8;
		}
...
IL_00cf:
	{
		...
		bool L_23;
		L_23 = Input_GetMouseButtonDown_m33522C56A54C402FE6DED802DD7E53435C27A5DE(2, NULL);
		if (!L_23)
		{
			goto IL_00e3;
		}
...
IL_00e3:
	{
		...
		bool L_25;
		L_25 = Input_GetMouseButtonUp_m69FCCF4E6D2F0E4E9B310D1ED2AD5A6927A8C081(2, NULL);
		if (L_25)
		{
			goto IL_00f3;
		}
	...
	{
		bool L_26;
		L_26 = Input_GetMouseButton_mE545CF4B790C6E202808B827E3141BEC3330DB70(2, NULL);
		if (L_26)
		{
			goto IL_00fa;
		}
...
IL_00fa:
	...
	}
	{
		...
		float L_37;
		L_37 = Mathf_Clamp_m154E404AF275A3B2EC99ECAA3879B4CB9F0606DC_inline(((float)il2cpp_codegen_multiply(L_33, L_34)), ((-L_35)), L_36, NULL);
		*((float*)L_30) = (float)((float)il2cpp_codegen_add(L_31, L_37));
		...
		float L_47;
		L_47 = Mathf_Clamp_m154E404AF275A3B2EC99ECAA3879B4CB9F0606DC_inline(((float)il2cpp_codegen_multiply(((-L_43)), L_44)), ((-L_45)), L_46, NULL);
...
IL_017b:
	{
		...
		float L_56;
		L_56 = Mathf_Clamp01_mD921B23F47F5347996C56DC789D1DE16EE27D9B1_inline(((float)(((float)il2cpp_codegen_subtract(L_52, L_53))/((float)il2cpp_codegen_subtract(L_54, L_55)))), NULL);
		float L_57;
		L_57 = Mathf_Lerp_mFB4910B358B986AFB22114ED90458E8341867479_inline(L_50, L_51, L_56, NULL);
		V_4 = L_57;
...
IL_01e2:
	{
		...
		bool L_66;
		L_66 = Input_GetKeyDown_m0D59B7EBC3A782C9FBBF107FBCD4B72B38D993B3(((int32_t)114), NULL);
		if (!L_66)
		{
			goto IL_01f1;
		}
...
IL_0275:
	{
		...
		float L_108;
		L_108 = Input_GetAxis_m1F49B26F24032F45FB4583C95FB24E6771A161D4(_stringLiteralFC6687DC37346CD2569888E29764F727FAF530E0, NULL);
		V_2 = L_108;
		...
		float L_115;
		L_115 = Mathf_Clamp_m154E404AF275A3B2EC99ECAA3879B4CB9F0606DC_inline(L_112, ((-L_113)), L_114, NULL);
		...
		float L_120;
		L_120 = Vector3_Distance_m99C722723EDD875852EF854AD7B7C4F8AC4F84AB_inline(L_117, L_119, NULL);
...
IL_03d0:
	{
		...
		L_137 = Vector3_Lerp_m57EE8D709A93B2B0FF8D499FA2947B1D61CB1FD6_inline(L_133, L_134, ((float)il2cpp_codegen_multiply(L_135, L_136)), NULL);
		...
		float L_146;
		L_146 = Mathf_Lerp_mFB4910B358B986AFB22114ED90458E8341867479_inline(L_143, (0.0f), ((float)il2cpp_codegen_multiply(L_144, L_145)), NULL);
		...
		L_148 = Vector3_get_zero_m9D7F7B580B5A276411267E96AA3425736D9BDC83_inline(NULL);
		...
		L_151 = Vector3_Lerp_m57EE8D709A93B2B0FF8D499FA2947B1D61CB1FD6_inline(L_147, L_148, ((float)il2cpp_codegen_multiply(L_149, L_150)), NULL);
		__this->___moveAcceleration_18 = L_151;
		// mouseDelta = Input.mousePosition;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_152;
		L_152 = Input_get_mousePosition_m2414B43222ED0C5FAB960D393964189AFD21EEAD(NULL);
