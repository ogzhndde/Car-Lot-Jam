...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 TCP2_GetPosOnWater_GetPositionOnWater_mD8E5940462F4FF4F18FF94C754B96068EF77F4CB (TCP2_GetPosOnWater_tAEFF9D18028A8FDE5B4697289D69F0E4ABE74973* __this, Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 ___worldPosition0, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Debug_LogWarning_mEF15C6B17CE4E1FA7E379CDB82CE40FCD89A3F28(_stringLiteral6EE10BE9A84B8EE696062A84A890739F72DD0CAE, NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 TCP2_GetPosOnWater_GetNormalOnWater_mFCFCCF422D5C271B4DB3D451527ADA2026B0F266 (TCP2_GetPosOnWater_tAEFF9D18028A8FDE5B4697289D69F0E4ABE74973* __this, Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 ___worldPosition0, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
		Debug_LogWarning_mEF15C6B17CE4E1FA7E379CDB82CE40FCD89A3F28(_stringLiteral48167882D06D213282D0B0265043EDB047203572, NULL);
		// return Vector3.up;
...
IL_002d:
	{
		...
		L_9 = Camera_get_current_m6D76274A65CF75DD2AE6CAC2A1DDADB39C184C66(NULL);
		V_1 = L_9;
		// if (!cam)
...
IL_0044:
	{
		...
		int32_t L_18;
		L_18 = QualitySettings_get_pixelLightCount_m55798296475C8D4612633D9F0F1A625614506547(NULL);
		V_5 = L_18;
...
IL_0081:
	{
		...
		L_33 = Matrix4x4_get_zero_m151153EC215245E44A720FA640E93FA5959B4815(NULL);
		V_8 = L_33;
		// CalculateReflectionMatrix(ref reflection, reflectionPlane);
		Vector4_t58B63D32F48C0DBF50DE2C60794C4676C80EDBE3 L_34 = V_7;
		TCP2_PlanarReflection_CalculateReflectionMatrix_m0016111B53379038725C27EE81E1951E1747C55B((&V_8), L_34, NULL);
		...
		L_44 = Matrix4x4_op_Multiply_m7649669D493400913FF60AFB04B1C19F14E0FDB0(L_42, L_43, NULL);
		NullCheck(L_40);
...
IL_01cd:
	...
	}
	{
		...
		int32_t L_90 = V_5;
		QualitySettings_set_pixelLightCount_mCC2FF98A5D748E09723691EF0406329EF4B26C3E(L_90, NULL);
	}
...
IL_0036:
	{
		...
		String_t* L_14;
		L_14 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(_stringLiteral05E47A2F07E9D9A37CF82B8B7292B8D0073324FD, L_13, NULL);
		NullCheck(L_11);
...
IL_0097:
	...
	}
	{
		...
		String_t* L_30;
		L_30 = String_Concat_mF8B69BE42B5C5ABCAD3C176FBBE3010E0815D65D(_stringLiteral4017354CE7C7E8601B2045AD090F32A21FE80F01, L_26, _stringLiteralF422850993212057809CBD984B2F3DAEC17A02ED, L_29, NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR float TCP2_PlanarReflection_sgn_m02B52584666C862CF709CD23432B90AB7F38FD79 (float ___a0, const RuntimeMethod* method) 
{
	{
